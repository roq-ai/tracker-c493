...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiCoffee, FiBriefcase } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'team-member', 'nutritionist', 'administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Meal', path: '/meals', entity: 'meal', service: AccessServiceEnum.PROJECT, icon: FiCoffee },
